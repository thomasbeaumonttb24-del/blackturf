...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;table-layout:fixed;margin-top:24px;border-top:1px solid #d6d9cf"><tr><td style="padding:24px 4px 4px"><table role="presentation" cellpadding="0" cellspacing="0"><tr><td width="42" valign="middle"><a href="{INSTAGRAM}" aria-label="Instagram BlackTurf"><img src="{SITE}/img/email/instagram-glyph.png" width="32" height="32" alt="Instagram" style="display:block;width:32px;height:32px;border:0"></a></td><td valign="middle" style="font-size:18px;line-height:24px;font-weight:bold;color:#142b23">La suite se passe aussi sur Instagram.</td></tr></table><p style="margin:10px 0 12px;color:#515952">Les infos du jour et les publications BlackTurf, entre deux lettres.</p><a href="{INSTAGRAM}" style="color:#725519;font-weight:bold;text-decoration:underline">Suivre @blackturf.fr →</a></td></tr></table>
