 ...
 *
 * Cinq vues sur la même vérité : ce que le système a conseillé, ce que ça a
...
export default function SupervisionIAPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/60">
      <div className="mx-auto max-w-[1400px] space-y-5 px-3 py-5 sm:px-5 sm:py-7">
        ...
        <header className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-[11px] font-semibold text-gray-600 transition-colors hover:bg-gray-50"
            >
              {live ? <Pause className="h-3.5 w-3.5" /> : <Play className="h-3.5 w-3.5" />}
              <span className="hidden sm:inline">{live ? "Pause" : "Reprendre"}</span>
            </button>
            <button
