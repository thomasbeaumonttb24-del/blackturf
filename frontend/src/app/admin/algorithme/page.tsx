...
export default function SupervisionIAPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-5">
        ...
        actions={
          <>
            ...
            <div
              ...
              className="flex overflow-hidden rounded-xl border border-white/[0.07] bg-black/30 p-1 shadow-[inset_0_2px_6px_rgba(0,0,0,0.5)]"
            >
              {FENETRES.map((f) => (
                <button
                  key={f.days}
                  ...
                  className={cn(
                    "min-h-[2.25rem] rounded-lg px-3 text-xs font-semibold transition-all",
                    days === f.days
                      ? "bg-gradient-to-b from-amber-300 to-amber-600 text-[#1a1203] shadow-[0_6px_16px_-6px_rgba(245,158,11,0.8)]"
            ...
            <button
              ...
              className="inline-flex min-h-[2.5rem] items-center gap-1.5 rounded-xl border border-white/[0.08] bg-white/[0.04] px-3 text-xs font-semibold text-muted-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition-colors hover:border-amber-300/40 hover:text-foreground"
            >
      ...
      <div className="sticky top-14 z-20 -mx-3 bg-[#070912]/70 px-3 py-2 backdrop-blur-xl sm:-mx-5 sm:px-5 lg:top-0">
