  ...
  return (
    <details className={cn(CARTE, "group")}>
      ...
      <ol className="list-decimal space-y-2 border-t border-stone-100 pb-5 pl-10 pr-5 pt-4 text-[12.5px] leading-relaxed text-slate-700">
        ...
        <li>Les paris ferment <b>à l&apos;heure de départ annoncée au programme</b>, à l&apos;heure du serveur, et restent fermés si la course part en retard. Un pari validé est définitif : ni modifiable, ni annulable. Si le PMU avance une course, un pari validé après son départ réel est remboursé.</li>
