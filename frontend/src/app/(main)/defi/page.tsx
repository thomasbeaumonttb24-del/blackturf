  ...
  return (
    <details className={cn(CARTE, "group")}>
      ...
      <ol className="list-decimal space-y-2 border-t border-stone-100 pb-5 pl-10 pr-5 pt-4 text-[12.5px] leading-relaxed text-slate-700">
        ...
        <li>Les paris ferment <b>{regles.verrou_minutes} minutes avant le départ prévu</b>, à l&apos;heure du serveur. Un pari validé est définitif : ni modifiable, ni annulable. Si le PMU avance une course, un pari validé après son départ réel est remboursé.</li>
