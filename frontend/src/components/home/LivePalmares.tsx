    ...
    <div className={`metric-row flex items-center gap-3 rounded-xl border px-3 py-2.5 ${
      ...
      {rank != null && (
        <span className={`num-display flex h-6 w-6 shrink-0 items-center justify-center rounded-lg text-[11px] font-black ring-1 ${
          podium ?? "bg-white text-gray-400 ring-gray-200"
        }`}>
          {rank + 1}
        </span>
      )}
      ...
      <div className="shrink-0 text-right">
        <div className="num-display text-sm font-extrabold text-emerald-600 tabular-nums">+{g.gain.toFixed(0)}€</div>
    ...
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal>
            <div className="mb-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="glass-card rounded-2xl px-5 py-4 text-center">
                ...
                <div className="text-[11px] text-gray-500 mt-1">paris gagnants enregistrés</div>
              </div>
              <div className="glass-card rounded-2xl px-5 py-4 text-center">
                <div className="num-display text-2xl font-extrabold text-gray-900">{fmtInt(nbCourses)}</div>
                <div className="text-[11px] text-gray-500 mt-1">courses réglées, gagnées <span className="text-gray-400">et perdues</span></div>
              </div>
              <div className="glass-card rounded-2xl px-5 py-4 text-center">
                <div className="num-display text-2xl font-extrabold text-emerald-600">
                  {meilleurGain != null ? `+${meilleurGain.toFixed(0)}€` : "—"}
                </div>
                <div className="text-[11px] text-gray-500 mt-1">meilleur gain sur un pari</div>
              </div>
            </div>
          </ScrollReveal>
        )}
            ...
            <ScrollReveal>
              <div className="glass-card rounded-2xl p-5 sm:p-6 h-full">
                <div className="flex items-center justify-between gap-2 mb-4">
                  ...
                  <span className="text-[10px] text-gray-400">depuis le lancement</span>
                </div>
            ...
            <ScrollReveal delay={80}>
              <div className="glass-card rounded-2xl p-5 sm:p-6 h-full">
                <div className="flex items-center justify-between gap-2 mb-4">
                  ...
                  <span className="text-[10px] text-gray-400">les plus récents</span>
                </div>
                <div className="space-y-1.5">
          ...
          <ScrollReveal delay={120}>
            <div className="mt-8 rounded-2xl border border-brand-gold/20 bg-gradient-to-r from-amber-50/60 to-white px-5 py-5 sm:px-7 sm:py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <Link
                  href="/inscription"
                  className="press btn-shimmer inline-flex items-center gap-1.5 rounded-xl bg-brand-gold px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-amber-500/25 hover:bg-brand-gold-deep transition-colors"
                >
        ...
        <p className="mt-6 text-center text-[11px] text-gray-500 max-w-2xl mx-auto inline-flex items-center justify-center gap-1.5 w-full">
          <ShieldCheck className="h-3.5 w-3.5 text-gray-500 shrink-0" />
