...
import { LayoutDashboard, CalendarDays, Star, Trophy, Wallet, Flag, ListChecks, Tag } from "lucide-react";
...
// Suivi du capital exigent un compte, Paris de valeur est réservé aux abonnés).
const ITEMS_PUBLIC = [
  { ...R.coursesDuJour, icon: CalendarDays },
  { ...R.quinte, icon: Flag },
