...
const DISCIPLINE_IMG: Record<string, string> = {
  Plat:      "/img/disciplines/plat-v9.png",
  "Attelé":  "/img/disciplines/attele-v9.png",
  Monté:     "/img/disciplines/monte-v9.png",
  Obstacle:  "/img/disciplines/obstacle-v9.png",
  Haies:     "/img/disciplines/obstacle-v9.png",
  Steeple:   "/img/disciplines/obstacle-v9.png",
  Cross:     "/img/disciplines/obstacle-v9.png",
};
